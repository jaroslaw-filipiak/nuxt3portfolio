<template>
  <div id="cta" class="cta__layout2--wrapper">
    <div class="cta__layout2--inner">
      <div class="cta__layout2--header">
        <div class="pr-5">
...
<style lang="scss">
  .cta__layout2 {
    &--wrapper {
      @apply bg-cover bg-no-repeat min-w-full flex items-center;
    ...
    &--header {
      ...
      h4 {
        ...
        img {
          @apply relative hidden lg:block -left-20 lg:left-72 top-6;
        }
      }
    }

    &--middle {
      @apply flex flex-col lg:flex-row items-center justify-center lg:pb-8 lg:pl-8 lg:pr-8  gap-4 lg:gap-12 text-white;
    ...
    &--footer {
      @apply flex flex-row items-start justify-center relative -top-20;
