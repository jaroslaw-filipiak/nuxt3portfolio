<template>
  <div class="page-content" ref="main">
    <div class="pt-20 pb-3 pt-30 w-full bg-full-white text-dark-3">
      <div class="w-full lg:w-11/12 mx-auto pl-8 pr-8">
        <div class="politykaPrywatnosci">
          <h1 class="h1">
            Polityka prywatności <span class="label bc-1 c-grey-16"></span>
          </h1>
          ...
          <div class="lh166">
            <h2 class="pb-3 pt-3"><strong>1. Informacje ogólne</strong></h2>
            <ol>
              <li>
            ...
            <h2 class="pb-3 pt-3"><strong>3. Hosting</strong></h2>
            <ol>
              <li>
            ...
            <h2 class="pb-3 pt-3"><strong>6. Logi Administratora</strong></h2>
            <ol>
              <li>
...
<script setup>
  ...
  useHead({
    title: 'j-filipiak.pl - polityka prywatnośći',
    meta: [
      { charset: 'utf-8' },
