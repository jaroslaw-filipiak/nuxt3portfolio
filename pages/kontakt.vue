            ...
            <div v-if="resp" class="lg:pl-10 mt-5">
              <div
                ...
                :class="{
                  ...
                  'text-dark-3': resp?.data?.status === 'mail_sent',
...
<script setup>
  ...
  const send = async () => {
    ...
    form.append('imie', store.formData.name_surname);
    form.append('email', store.formData.email);
    form.append('telefon', store.formData.phone);
    ...
    axios
      .post(
        'https://j-filipiak.pl/api/wp-json/contact-form-7/v1/contact-forms/62/feedback',
        form
      )
