<template>
  <div
    class="page-content pt-40 pb-20 border border-dark-3 text-dark-3 pl-8 pr-8"
    ref="main"
  >
    <div class="container">
      <h1 class="text-5xl mb-10 max-w-[80%]">
      ...
      <div class="lh166">
        ...
        <ol>
          ...
          <li>
            Adres kontaktowy poczty elektronicznej operatora: info@j-filipiak.pl
          </li>
        ...
        <h2 class="pb-12">
          <strong
            >2. Wybrane metody ochrony danych stosowane przez Operatora</strong
          >
        </h2>
        <ol>
          <li>
        ...
        <ol>
          ...
          <li>
            ...
            przepisów o ochronie danych osobowych. Oznacza to, że przesyłamy je
        ...
        <ol>
          ...
          <li>
            ...
            <ul>
              <li>
                <a
                  class="link-with-undeline link-with-undeline__dark relative"
