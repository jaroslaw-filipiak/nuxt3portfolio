  ...
  <div>
    <div class="portfolio-item">
      ...
      <div class="portfolio-item--info">
        ...
        <p class="text-xl">
          Projekt graficzny został wykonany autorsko a następnie wdrożony do
          systemu WordPress .
        </p>
        <p>
          W pełni profesjonalne środowisko z wersjami : dev , stagging oraz prod
          , całość synchronizowana za pomocą ci/cd , które buduje stronę , oraz
          czyści cloudflarowe cache.<br />Layout zbudowany w oparciu o beaver
          builder + acf + autorskie bloki do beaver buildera +motyw pisany w
          oparciu o vite.js + tailwind
        </p>
      </div>
    </div>
    <Cta />
...
<script setup>
  import IMG from 'assets/uploads/2021/10/promise4cloud_main.jpg';
  useHead({
    title: 'Promise4Cloud - portfolio',
    meta: [
      { charset: 'utf-8' },
