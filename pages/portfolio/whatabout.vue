  ...
  <div ref="main">
    <div class="portfolio-item">
      ...
      <div class="portfolio-item--info">
        <h1 class="text-4xl mb-7">whatabout</h1>
        <p class="text-xl">Projekt graficzny oraz wykonanie strony www</p>
        <h3>
          Zlecenie obejmowało przygotowanie projektu graficznego oraz autorskie
          wdrożenie do systemu WordPress
        </h3>
        <p>
          Projekt grafizny wykonano w klasyku czyli Photoshopie. Animacje
          zostały zrobione w programie Adobe After Effects , następnie zostały
          one wyeksportowane za pomocą pluginu bodymovin do formatu .json oraz
          zaimportowane do specjalnego playera na stronie (lottie.js). Strona
          zakodowana autorsko do systemu CMS z wykorzystaniem Advanced Custom
          Fields oparta na startowym theme underscore
        </p>
      </div>
    </div>
    <Cta />
