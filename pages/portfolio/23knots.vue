  ...
  <div class="page-content" ref="main">
    <div class="portfolio-item min-h-max pb-16">
      ...
      <div class="portfolio-item--info">
        ...
        <p class="text-xl">
          Całkiem przyjemna wizytówka. Zakres prac obejmował zarówno
          przygotowanie projektu graficznego jak i wdrożenie. Kodowanie bez
          użycia CMS, wykorzystano webpacka + scss + esnext
        </p>
      </div>
    </div>
    <Cta />
...
<script setup>
  import IMG from 'assets/uploads/2020/03/23knots-header-bg.jpg';
